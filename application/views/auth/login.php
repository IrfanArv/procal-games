...
<head>
  ...
  <script type="text/javascript">
    ...
    $(".resultregist").html("<div class='alert alert-inverse loading '>Tunggu sebentar...</div>");
    ...
    $(".resultregist").html("<div class='alert alert-success login '>Memuat Data, Tunggu sebentar...</div>");
...
<lottie-player src="https://assets4.lottiefiles.com/packages/lf20_6tya3fib.json"  background="transparent"  speed="1"   hover loop  autoplay></lottie-player>
                </div>
            </div>
                    ...
                    <div class="form-items">
                        ...
                        <form method="POST" class="form-signin form-horizontal" role="form" onsubmit="return false;">
                            ...
                            <div class="form-button">
                                <button type="submit" class="ibtn ladda-button">Login</button>
